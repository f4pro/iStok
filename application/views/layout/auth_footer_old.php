...
<!-- Core -->
<script src="<?= base_url('assets_2/')?>assets/vendor/jquery/jquery.min.js"></script>
<script src="<?= base_url('assets_2/')?>assets/vendor/popper/popper.min.js"></script>
<script src="<?= base_url('assets_2/')?>assets/vendor/bootstrap/bootstrap.min.js"></script>
<script src="<?= base_url('assets_2/')?>assets/vendor/headroom/headroom.min.js"></script>
<!-- Argon JS -->
<script src="<?= base_url('assets_2/')?>js/argon.js?v=1.0.0"></script>
</body>
