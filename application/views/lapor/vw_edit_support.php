            ...
            <div class="card-body">
              <form action="" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-row">
                  <div class="form-group col-md-4">
                    ...
                    <?php if ($support['rate'] == "URGENT") { ?>
                      <button class="btn btn-danger form-control">URGENT</button>
                    <?php } elseif ($support['rate'] == "MEDIUM") { ?>
                      <button class="btn btn-warning form-control">MEDIUM</button>
                    <?php } else { ?>
                      <button class="btn btn-info form-control">LOW</button>
                    <?php } ?>
                  </div>
                  <div class="form-group col-md-4">
                ...
                <div class="form-group">
                  ...
                  <input type="text" name='jenis_support' value="<?= $support['jenis_support']; ?>" class="form-control" id="jenis_support">
                </div>
                <div class="form-group">
                  <label for="email">Descripsi</label>
                  <textarea class="form-control" id="example-textarea" rows="4" disabled></textarea>
                </div>
                <hr class="my-4">
                <div class="form-group">
                ...
                <div class="form-row">
                  <div class="form-group col-md-6">
                    <a href="<?= base_url('Account/') ?>" class="btn btn-secondary form-control">Kembali</a>
                  </div>
                  <div class="form-group col-md-6">
